package com.cube.cubeacademy.radioextension
 ...
 * @see RadioButton
 */
class RadioGroupExtension : LinearLayout {
    /**
     *
...
//        attributes.recycle();
    ...
    override fun getAccessibilityClassName(): CharSequence {
        return RadioGroup::class.java.getName()
    }
    ...
    interface OnCheckedChangeListener {
         ...
         */
        fun onCheckedChanged(group: RadioGroupExtension?, @IdRes checkedId: Int)
    }
    ...
    private inner class PassThroughHierarchyChangeListener : OnHierarchyChangeListener {
        ...
        override fun onChildViewAdded(parent: View, child: View) {
            traverseTree(child)
            if (parent === this@RadioGroupExtension && child is RadioButton) {
                var id = child.getId()
                // generates an id if it's missing
                if (id == NO_ID) {
                    id = generateViewId()
